...
class Migration124ManagerReportsMessagesHardening
{
    public function up(PDO $pdo): void
    {
        $this->addColumn($pdo, 'report_runs', 'scope_role', 'VARCHAR(40) NULL');
        $this->addColumn($pdo, 'report_runs', 'scope_user_id', 'INT UNSIGNED NULL');
        $this->addIndex($pdo, 'report_runs', 'idx_report_runs_scope', 'scope_role, scope_user_id, created_at');
    }

    public function down(PDO $pdo): void
    {
        $this->dropIndex($pdo, 'report_runs', 'idx_report_runs_scope');
    }
