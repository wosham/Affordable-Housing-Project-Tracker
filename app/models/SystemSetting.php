...
class SystemSetting extends Model
{
    ...
    public static function definitions(): array
    {
        return [
            ...
            ['key' => 'reports.footer_note', 'group' => 'reports', 'label' => 'Report footer note', 'description' => 'Printed under exported HTML reports.', 'type' => 'text', 'default' => 'Generated from live AHPTC database records. Verify figures against approved source documents before statutory filing.', 'sort' => 20],
