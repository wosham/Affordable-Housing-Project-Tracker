...
$tasks = $project ? ContractorProject::programmeTasks($projectId, $userId, $role, 6) : [];
...
<section class="contractor-project-hero card"
  ...
  <div>
    ...
    <p>Submit measured project progress with a work summary, milestone note and site photo.</p>
  </div>
  <div class="contractor-project-actions">
    ...
    <a class="btn btn--outline" href="<?= Security::e(Url::to('admin/contractor/programme-of-works.php')) ?>"><i class="fa-solid fa-chart-gantt" aria-hidden="true"></i> Programme</a>
  </div>
</section>
...
<section class="contractor-project-grid contractor-project-grid--main">
  <article class="card contractor-progress-form-card">
    <div class="card__header">
      ...
      <span class="badge badge--info"><?= Security::e($project['name']) ?></span>
    </div>
    ...
    <form class="contractor-progress-form" data-progress-form enctype="multipart/form-data" data-original-progress="<?= (int)percentage($project['pct_complete'] ?? 0) ?>">
      ...
      <section class="contractor-evidence-picker" data-evidence-picker>
        ...
        <div>
          <span class="contractor-evidence-picker__label"><i class="fa-solid fa-camera" aria-hidden="true"></i> Site photo</span>
  ...
  <aside class="card">
    <div class="card__header"><div><h2 class="card__title">Current Programme</h2><p class="card__subtitle">Use active tasks to support your update.</p></div></div>
...
<section class="card">
  ...
  <div class="contractor-timeline contractor-timeline--wide">
    ...
    <?php foreach ($history as $item): ?>
      <article class="contractor-timeline-item">
        ...
        <p><?= Security::e(safe_truncate($item['work_summary'] ?: ($item['note'] ?? ''), 180)) ?></p>
