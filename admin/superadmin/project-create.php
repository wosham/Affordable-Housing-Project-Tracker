...
if (Security::isPost()) {
    ...
    if ($errors === []) {
        ...
        if (Project::slugExists($slug)) {
            ...
            try {
                $projectId = Project::create(project_payload($old, $slug));
...
<form class="sa-project-form" method="post" enctype="multipart/form-data" action="<?= Security::e(Url::to('admin/superadmin/project-create.php')) ?>">
  <?= Csrf::field($csrfForm) ?>
