...
<head>
  ...
  <meta name="description" content="Staff portal login â€” Trans-Nzoia Affordable Housing Programme Tracker">
    ...
    <aside class="auth-brand" aria-label="Site branding">
      ...
      <div class="auth-brand-inner">
        <div class="auth-brand-top">
          <a href="../index.php" class="auth-logo" aria-label="Trans-Nzoia AHP â€” Home">
        ...
        <div class="auth-brand-body">
          ...
          <p class="auth-brand-sub">The Trans-Nzoia Affordable Housing Programme management system â€” secure, real-time, county-wide oversight.</p>
          <div class="auth-brand-stats" aria-label="Programme at a glance">
            <div class="auth-bs-item">
              <span class="auth-bs-num">5</span>
              <span class="auth-bs-lbl">Constituencies</span>
            </div>
            <div class="auth-bs-div" aria-hidden="true"></div>
            <div class="auth-bs-item">
              <span class="auth-bs-num">1,200+</span>
              <span class="auth-bs-lbl">Units Tracked</span>
            </div>
            <div class="auth-bs-div" aria-hidden="true"></div>
            <div class="auth-bs-item">
    ...
    <main class="auth-form-panel" id="main-content">
      <div class="auth-form-inner">
        ...
        <div class="auth-help">
          ...
          <a href="unauthorised.php" class="auth-help-link auth-help-link--muted">
