...
<head>
  ...
  <meta name="description" content="Access denied â€” Trans-Nzoia AHP Tracker">
  ...
  <link rel="stylesheet" href="unauthorised.css">
</head>
<body>
  ...
  <main class="unauth-page" id="main-content" role="main">
    ...
    <div class="unauth-topbar">
      <a href="../index.php" class="unauth-logo" aria-label="Trans-Nzoia AHP â€” Home">
  ...
  <script src="unauthorised.js"></script>
</body>
</html>
